        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {CAUSES.map((c) => {
            ...
            return (
              <article
                key={c.id}
                className="group flex flex-col overflow-hidden rounded-2xl bg-card shadow-card transition hover:shadow-elevated"
              >
                ...
                <div className="flex flex-1 flex-col p-5">
                  ...
                  <button className="mt-5 inline-flex items-center gap-1 text-sm font-semibold text-primary hover:gap-2 transition-all">
